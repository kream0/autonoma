 ...
 */
function findBestDriver(pickupLocation, vehicleCategory) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const db = admin.firestore();
        // Query available drivers with matching vehicle category
        const driversSnapshot = yield db
            .collection("drivers")
        ...
        for (const doc of driversSnapshot.docs) {
            ...
            const driver = {
                ...
                name: data.name || "",
                location: {
                    lat: ((_a = data.location) === null || _a === void 0 ? void 0 : _a.lat) || 0,
                    lng: ((_b = data.location) === null || _b === void 0 ? void 0 : _b.lng) || 0,
                },
            ...
            candidates.push(Object.assign(Object.assign({}, driver), { distanceKm }));
        }
 ...
 */
function findNearestDrivers(pickupLocation_1, vehicleCategory_1) {
    return __awaiter(this, arguments, void 0, function* (pickupLocation, vehicleCategory, limit = 5) {
        const result = yield findBestDriver(pickupLocation, vehicleCategory);
